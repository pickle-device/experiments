...
SCHEDULING_POLICY=("first_in_first_out")
        ...
        do
            ...
            do
                ...
                do
                    ...
                    do
                        for prefetch_scheduling_policy in "${SCHEDULING_POLICY[@]}"
                        do
                            ...
                            # we need to replace all underscores from the scheduling policy name with dots since we use underscores as separators in the output directory name
                            policy_name=$(echo $prefetch_scheduling_policy | tr '_' '.')
