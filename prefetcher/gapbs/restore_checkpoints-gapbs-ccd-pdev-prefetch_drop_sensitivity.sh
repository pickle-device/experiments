...
PREFETCH_DISTANCE_DROP_DISTANCE_PAIRS=( "32:0" )
#PREFETCH_DISTANCE_DROP_DISTANCE_PAIRS=( "32:4" "32:8" ) # for bfs
PDEV_TBES=(64)
PREFETCH_AGENT=("True")
