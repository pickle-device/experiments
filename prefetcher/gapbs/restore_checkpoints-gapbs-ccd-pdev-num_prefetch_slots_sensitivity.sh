...
do
    ...
    do
        for num_prefetch_slots in "${NUM_PREFETCH_SLOTS[@]}"
        do
                    ...
                    do
                        ...
                        do
                            ...
                            HOME=/workdir /workdir/gem5/build/ARM/gem5.opt \
                                ...
                                --concurrent_work_item_capacity=$num_prefetch_slots \
