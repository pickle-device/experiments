...
do
    ...
    do
        for ddr_technology in "${DDR_TECHNOLOGIES[@]}"
        do
                    ...
                    do
                        ...
                        do
                            ...
                            HOME=/workdir /workdir/gem5/build/ARM/gem5.opt \
                                ...
                                --ddr_technology=$ddr_technology \
                                --mesh $mesh &
                        done
                    done
                done
            done
            echo "Running $application-$graph_name with no prefetchers and ddr technology $ddr_technology"
            HOME=/workdir /workdir/gem5/build/ARM/gem5.opt \
                -re \
                --outdir=$OUTPUT_FOLDER/$application-$graph_name-mesh_$mesh-baseline-ddr_$ddr_technology \
                --debug-flags=PickleDevicePrefetcherProgressTracker \
                experiments/prefetcher/gem5_configurations/restore_checkpoint.py \
                --application $application \
                --graph_name=$graph_name \
